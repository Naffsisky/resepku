    ...
    <section className="relative overflow-hidden pt-6 pb-8 sm:pt-12 sm:pb-14 bg-gradient-to-b from-emerald-50/70 via-emerald-50/30 to-transparent dark:from-emerald-950/40 dark:via-emerald-950/10 dark:to-transparent">
      ...
      <div className="relative max-w-4xl mx-auto px-3.5 sm:px-6 text-center">
        ...
        <div className="mt-3.5 sm:mt-4 flex flex-wrap items-center justify-center gap-1.5 sm:gap-2">
          <span className="text-[11px] sm:text-xs font-medium text-gray-700 dark:text-gray-200 flex items-center gap-1 mr-0.5">
          ...
          {QUICK_TAGS.map((tag) => (
            <button
              ...
              className="px-2 sm:px-2.5 py-0.5 sm:py-1 text-[11px] sm:text-xs font-medium rounded-lg bg-white/90 dark:bg-emerald-950/60 hover:bg-emerald-50 dark:hover:bg-emerald-900/60 text-emerald-900 dark:text-emerald-200 border border-emerald-200/50 dark:border-emerald-800/50 transition-all active:scale-95"
            >
              {tag.name}
            </button>
          ))}
          <button
            ...
            className="px-2.5 py-1 text-[11px] sm:text-xs font-bold rounded-lg bg-amber-100 dark:bg-amber-950/60 text-amber-900 dark:text-amber-200 hover:bg-amber-200 border border-amber-300/60 dark:border-amber-700/50 transition-all flex items-center gap-1 active:scale-95"
          >
